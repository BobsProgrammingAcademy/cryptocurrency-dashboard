...
This is a cryptocurrency dashboard app built using **React 17.0.2**, **Material UI 5.5.2** and **Chart.js 3.7.1**. The app uses the **CoinGecko API** to get cryptocurrency data such as live prices, trading volume, exchange volumes, historical data, crypto categories, images, and more.
